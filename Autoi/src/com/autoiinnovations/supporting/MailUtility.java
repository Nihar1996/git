...
{  		
		...
		public String sendEmail(String useremail,String genPassword){
			...
			//  final String user="brings.gvn@gmail.com";//change accordingly
			 // final String user="myteamdiscussion@gmail.com";//change accordingly  
			  final String user="support@autoiinnovations.com";
			  ...
			  //Get the session object  
			   ...
			   //Compose the message  
			    try {  
			     ...
			     message.setSubject("Temporary password From Autoi");  
			     message.setText("Temporary password generated successfully  : " + genPassword);  
		...
		public String sendFeebbackEmail(String useremail,String email,String name,String subject,String message1){
			  String status="";
			 // String host="smtp.gmail.com";  
			  String host="mail.brings.co.in";  
			//  final String user="brings.gvn@gmail.com";//change accordingly
			  ...
			  //Get the session object  
			   ...
			   //Compose the message  
			    try {  
			     ...
			     message.setText("name : "+name +" email : "+email+" subject : "+subject+" message : "+message1);  
