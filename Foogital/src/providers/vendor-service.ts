...
export class VendorService {
  ...
  getFoodType(credentials){

    return new Promise((resolve, reject) =>{
      let headers = new Headers();
      this.http.post('https://www.autoiinnovations.com/TestProject/rest/vendor/getFoodType', {test: credentials.test}, {headers: headers}).
      subscribe(res =>{
        resolve(res.json());
      }, (err) =>{
        reject(err);
  ...
  addFood(credentials){
    ...
    return new Promise((resolve, reject) =>{
      let headers = new Headers();
      this.http.post('https://www.autoiinnovations.com/TestProject/rest/vendor/addFood', {credentials}, {headers: headers}).
      subscribe(res =>{
        resolve(res.json());
      }, (err) =>{
        reject(err);
  ...
  showMenu(credentials){
    ...
    return new Promise((resolve, reject) =>{
      let headers = new Headers();
      this.http.post(' https://www.autoiinnovations.com/TestProject/rest/vendor/showMyMenu', {credentials}, {headers: headers}).
      subscribe(res =>{
        resolve(res.json());
      }, (err) =>{
        reject(err);
